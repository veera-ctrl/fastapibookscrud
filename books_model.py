...
#     publish_year:int
# 
#     def __init__(self,id,title,description,author,rating,publish_year):  # published_date renamed to publish_year
#         self.id=id
#         self.title=title
#         self.description=description
#         self.author=author
#         self.rating=rating
#         self.publish_year=publish_year  # was: self.published_date
# 
# 
